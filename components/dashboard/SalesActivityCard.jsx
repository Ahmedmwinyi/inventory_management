...
export default function SalesActivityCard({ item }) {
  return (
    <Link
      href={item.href}
      className="shadow rounded-lg border border-slate-200 hover:border-blue-400 bg-white px-2 py-2 cursor-pointer flex items-center flex-col gap-3 transition-all duration-300"
    >
